package com.uit.tourism_article_management.media.application;

import com.uit.tourism_article_management.application.command.sync.media.upload_resource.UploadResourceCommand;
import com.uit.tourism_article_management.application.command.sync.media.upload_resource.UploadResourceResult;
